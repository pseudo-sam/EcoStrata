The objective was to develop a robust predictive model for income bracket classification using data analytics techniques.
...
The test and training datas used for model are in Dataset folder.
